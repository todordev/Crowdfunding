 ...
 * @since    12.1
 */
abstract class CrowdfundingTestCaseDatabase extends PHPUnit_Extensions_Database_TestCase
{
	/**
	...
	{
        $databaseFile = JPATH_ROOT .'/tmp/crowdfunding.sqlite';
...
//			$pdo = new PDO('sqlite::memory:');
			...
			$pdo->exec(file_get_contents(CROWDFUNDING_TESTS_FOLDER_SCHEMA . '/ddl.sql'));
