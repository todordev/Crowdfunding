 ...
 * @subpackage   Payments
 */
class ServiceData implements Entity
{
    use EntityId;
     ...
     * $repository     = new Crowdfunding\Payment\Session\Repository;
     ...
     *
     * <code>
     * $serviceData = new Crowdfunding\Payment\Session\ServiceData;
     *
