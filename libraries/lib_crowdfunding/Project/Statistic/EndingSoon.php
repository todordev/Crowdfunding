...
/**
 * This class loads ending soon projects.
 *
 * @package      Crowdfunding\Project
 * @subpackage   Statistic
 */
class EndingSoon extends Base
{
    /**
     * Load ending soon projects.
     *
     * <code>
     * $options = array(
     *     'limit' => 10,
    ...
    public function load(array $options = array())
    {
        ...
        $query
            ...
            ->where('a.funding_end >= ' . $this->db->quote($today) . ' AND a.funding_end <= '. $this->db->quote($date->toSql()));
