...
?>
<form action="<?php echo JRoute::_('index.php?option=com_crowdfunding&view=regions'); ?>" method="post"
    ...
    <div id="j-main-container" class="span10">
        ...
        <div id="j-main-container">
            ...
            <table class="table table-striped" id="regionsList">
            ...
            <input type="hidden" name="code" value="<?php echo $this->country->getCode(); ?>"/>
